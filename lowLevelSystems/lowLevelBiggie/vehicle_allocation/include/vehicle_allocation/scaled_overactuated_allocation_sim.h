...
namespace alloc {
	...
	class scaledOveractuatedAllocationSim
	{
	public:
		scaledOveractuatedAllocationSim(ros::NodeHandle &nh);
		~scaledOveractuatedAllocationSim();
	...
	private:
		...
		ros::Publisher sim_port_ang_pub;
		ros::Publisher sim_stbd_pub;
		ros::Publisher sim_stbd_ang_pub;
