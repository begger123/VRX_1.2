class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('labels', '/home/thedoctor/Programming/docker_vrx/test_cws/src/VRX_1.2/highLevelSystems/visionSystemsBiggie/yolo_detection/src/placard.names', 'path to labels file')
